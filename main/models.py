...
class Interview(models.Model):
    ...
    logic_skill  = models.IntegerField(choices=ASSIGN_CHOICES, verbose_name="Харилцаа өөрийгөө илэрхийлэх чадвар", null=True, blank=True)
    attitude  = models.IntegerField(choices=ASSIGN_CHOICES, verbose_name="Харилцаа өөрийгөө илэрхийлэх чадвар", null=True, blank=True)
    independence  = models.IntegerField(choices=ASSIGN_CHOICES, verbose_name="Харилцаа өөрийгөө илэрхийлэх чадвар", null=True, blank=True)
    responsibility  = models.IntegerField(choices=ASSIGN_CHOICES, verbose_name="Харилцаа өөрийгөө илэрхийлэх чадвар", null=True, blank=True)
    leadership  = models.IntegerField(choices=ASSIGN_CHOICES, verbose_name="Харилцаа өөрийгөө илэрхийлэх чадвар", null=True, blank=True)
    knowledge  = models.IntegerField(choices=ASSIGN_CHOICES, verbose_name="Харилцаа өөрийгөө илэрхийлэх чадвар", null=True, blank=True)
    overall_score  = models.IntegerField(choices=ASSIGN_CHOICES, verbose_name="Харилцаа өөрийгөө илэрхийлэх чадвар", null=True, blank=True)
